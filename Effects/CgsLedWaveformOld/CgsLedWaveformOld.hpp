...
#include "ui_CgsLedWaveformOld.h"
#include "CgsLedEffect.hpp"

namespace Ui {
    class CgsLedWaveformOld;
}
...
class CgsLedWaveformOld : public CgsLedEffect {
    Q_OBJECT
    CGS_LED_EFFECT(CgsLedWaveformOld, "Waveform Old")
...
protected:
    ...
    virtual void draw(std::vector<ControllerZone*> zones) override;
