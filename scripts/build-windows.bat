::---------------------------------------------------------::
:: OpenRGB Effects Plugin Windows Build Script             ::
::                                                         ::
:: Sets up build environment for desired Qt version and    ::
:: build architecture, then builds OpenRGB Effects Plugin  ::
::                                                         ::
:: Prerequisites:                                          ::
...
::---------------------------------------------------------::
qmake OpenRGBEffectsPlugin.pro CONFIG-=debug_and_release CONFIG+=release
...
::---------------------------------------------------------::
move "release" "OpenRGBEffectsPlugin Windows %BITS%-bit"
